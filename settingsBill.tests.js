describe('The Settings Bill', function () {
    describe('Set Values', function () {
        ...
        it('should be able to set the sms & call cost', function () {
            let settingsBill = BillWithSettings();
    ...
    describe('Use Values', function () {
        ...
        it("should be able to to send 2 sms's at 0.85 each", function () {
        ...
        it("should be able to to send 2 sms's at 0.85 & make one call at 1.35", function () {
